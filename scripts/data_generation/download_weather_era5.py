...
def main():
    ...
    real_building_ds = [
        ("LCL", "london", "2011-01-01", "2014-12-31", 0),
        ("IDEAL", "edinburg", "2017-01-01", "2018-12-31", 0),
        ("Sceaux", "sceaux", "2006-12-31", "2011-01-01", 1),
        ("Borealis", "waterloo", "2010-12-31", "2013-01-01", -5),
        ("Electricity", "lisbon", "2011-01-01", "2014-12-31", 0),
        ("SMART", "massachusetts", "2013-12-31", "2017-01-01", -5),
        ("Panther", "ucf", "2015-12-31", "2018-01-01", -5),
        ("Fox", "asu", "2015-12-31", "2018-01-01", -7),
        ("Bear", "uc-b", "2015-12-31", "2018-01-01", -8),
        ("Rat", "dc", "2015-12-31", "2018-01-01", -5),
    ]
    ...
    for ds in real_building_ds:
        ...
        weather = get_hourly_weather_pandas(
            ds[2],
            ds[3],
            AREA_LONLAT[ds[1]],
        ...
        weather["2m_temperature"] = weather["2m_temperature"].apply(
            lambda x: x - 273.15
        )
        weather["2m_dewpoint_temperature"] = weather["2m_dewpoint_temperature"].apply(
            lambda x: x - 273.15
        )

        weather["humidity"] = weather.apply(
            lambda x: calc_relative_humidity(
                x["2m_temperature"], x["2m_dewpoint_temperature"]
            ),
            axis=1,
        )
