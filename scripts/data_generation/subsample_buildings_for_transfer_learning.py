...
for dataset in datasets:
    building_datasets_generator = load_pandas_dataset(
...
with open(
    dataset_path / "metadata" / "transfer_learning_residential_buildings.txt", "w"
) as f:
    for b in residential_buildings:
        f.write(f"{b}\n")

with open(
    dataset_path / "metadata" / "transfer_learning_commercial_buildings.txt", "w"
) as f:
