...
class MoETransformerEncoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        src = src + self.moe_ffn(self.ffn_norm(src))
...
class MoETransformerDecoderLayer(nn.Module):
    def __init__(
        ...
        self.attn_norm1 = RMSNorm(d_model)
        self.attn_norm2 = RMSNorm(d_model)
        self.ffn_norm = RMSNorm(d_model)
    ...
    def forward(
        ...
        **kwargs,
        ...
        tgt = tgt + self.moe_ffn(self.ffn_norm(tgt))
        return tgt
